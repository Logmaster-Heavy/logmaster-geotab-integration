    ...
    enableDisplayToggle(){
        ...
        displayToggle.addEventListener('click', () => {
            if(this.focus){
                ...
                global.geotab.addin.logmasterEwd2.blur();
            } else {
                displayToggle.innerHTML = 'Blur add-in';
                global.geotab.addin.logmasterEwd2.focus(global.api, global.state);
            }
    ...
    listenToHash(){
        ...
        setInterval(()=>{
            if(window.location.hash !== this.storedHash){
                this.storedHash = window.location.hash;
                if(this.storedHash !== '#' + 'logmasterEwd2'){
                    geotab.addin.logmasterEwd2.blur();
                } else {
                    geotab.addin.logmasterEwd2.focus(global.api, global.state);
                }
            }
        }, 100);
    }
